...
public class SearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
		 * String page =
		 * getHTMLString(req.getServletContext().getRealPath("/html/searchResults.html")
		 * , products); resp.getWriter().write(page);
		 */
	...
	/**
	 * this methods reads the HTML template as a String, replaces placeholders with
	 * the values and returns the entire page as a String
	 * 
	 * @param filePath
	 * @param products
	 * @return
	...
	public String getHTMLString(String filePath, List<Product> products) throws IOException {
		...
		page = MessageFormat.format(page, products.get(0).getProductImgPath(), products.get(1).getProductImgPath(),
				products.get(2).getProductImgPath(), products.get(0).getProductName(), products.get(1).getProductName(),
