...
public class HomeServlet extends HttpServlet {
	 ...
	 * System.out.println("in init method"); connection =
	 * DBConnection.getConnectionToDatabase(); }
	 * 
	 * @Override public void destroy() { System.out.println("in destroy method");
	 * 
	 * //clean up activity - close DB connection object try { connection.close(); }
